...
// ==========================================================================
// No seu app.js, a configuração do Handlebars deve ficar assim:
app.engine(
  "handlebars",
  engine({
    extname: "handlebars",
    defaultLayout: "main",
    helpers: {
        // ESSA FUNÇÃO É O QUE PERMITE COMPARAR user.tipo === "parceiro"
...
// ==========================================================================
// 4. MIDDLEWARES (Sessão, Flash e Ativos)
// ==========================================================================
app.use(express.static(path.join(__dirname, "public")));
app.use(express.urlencoded({ extended: true }));
app.use(express.json());

// Configuração de Sessão (FASE 4)
app.use(session({
    secret: 'chave-secreta-cogitare-fatec',
    resave: false,
    saveUninitialized: true,
    cookie: { maxAge: 24 * 60 * 60 * 1000 } // 1 dia de duração
}));

app.use(flash());

// Middleware Global (IHC: Feedback e Persistência de Estado)
...
// ==========================================================================
// 5. MIDDLEWARE DE SEGURANÇA (O Guardião)
// ==========================================================================
...
// ==========================================================================
// 8. ROTAS PROTEGIDAS (Dashboards e Inventário)
// ==========================================================================
...
// Dashboard Parceiro (Com trava de segurança por Perfil)
...
const PORT = 3000;
app.listen(PORT, () => {
  console.log(`\n🚀 COGITARE RODANDO EM: http://localhost:${PORT}\n`);
});